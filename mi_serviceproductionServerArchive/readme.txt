mi_service for MATLAB Production Server

Before you can use the functions packaged by the compiler, you need to do the following:
* Deploy mi_service.ctf to a server instance
* Develop a client application to access the functions.

1. Deploy mi_service.ctf

1.1 Prerequisites to Deployment
Before you can deploy mi_service.ctf, you need a server instance to host it. The server 
...
1.2 mi_service.ctf Deployment
To deploy mi_service.ctf, copy it into the server instance's `auto_deploy` folder. The 
